/////////////////////////////////////////////////////////////////////
// TestExecutive.cpp - key/value pair in-memory database           //
//                                                                 //
// Rahul Vijaydev, CSE687 - Object Oriented Design, Spring 2017    //
/////////////////////////////////////////////////////////////////////
//
//Description:The test executive is the entry point to the project.
//It demonstrates all the project requirements.
//
//
...
int main() {
	...
	DBHandler<StrData> dbH("../XMLfiles/StringDB.xml",5);
	dbH.fromXml("../XMLfiles/StringDB.xml");
	dbH.showDbContent();
	...
	DBHandler<intData> idbH("../XMLfiles/intDb.xml",5);
	...
	std::vector<Key> unionVect=dbH.formKeyUnion(intResVect,intResVect1);
	for (Key ke : unionVect) {
		std::cout << " Key " << ke << " is part of union of vectors \n";
	}
